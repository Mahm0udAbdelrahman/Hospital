                ...
                <div class="card custom-card">
                    ...
                    <div class="card-body">
                        <table id="responsivemodal-DataTable" class="table table-bordered text-nowrap" style="width:100%">
                            <a href="{{ route('competencies.create') }}" class="btn btn-primary">Create</a>
                            <thead>
                                <tr>
                                    <th>#</th>
                            ...
                            <tbody> 
                                @foreach ($data as $competency)
                                    ...
                                    <td>
                                        <img src="{{ $competency->image }}" width="75" height="75" alt="">
                                    </td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                ...
                                                <form method="post"
                                                    action="{{ route('competencies.destroy', $competency->id) }}">
                                                    @csrf
                                                    @method('delete')
