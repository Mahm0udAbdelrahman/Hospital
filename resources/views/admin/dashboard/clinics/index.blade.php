                ...
                <div class="card custom-card">
                    ...
                    <div class="card-body">
                        <table id="responsivemodal-DataTable" class="table table-bordered text-nowrap" style="width:100%">
                            <a href="{{ route('clinics.create') }}" class="btn btn-primary">Create</a>
                            <thead>
                                <tr>
                                    <th>#</th>
                            ...
                            <tbody>
                                @foreach ($data as $clinic)
                                    ...
                                    <td>
                                        ...
                                        <td>
                                            {{ Str::limit($clinic->description,25 )}}
                                        </td>

                                        @foreach ($clinic->getMedia('logo') as $imgs)
                                            <td>
                                        ...
                                        @foreach ($clinic->getMedia('image')  as $imgs)
                                            <td>
                                                <img src="{{ $imgs->getUrl() }}" width="75" height="75"
                                                    alt="">
                                            </td>
