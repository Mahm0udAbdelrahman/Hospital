...
<div class="d-md-flex d-block align-items-center justify-content-between page-header-breadcrumb">
    <div>
        <h2 class="main-content-title fs-24 mb-1">{{ __('Create Doctor') }}</h2>
                            ...
                            <div class="col-md-9">
                                ...
                                <select class="form-select js-example-basic-multiple" name="hospital_id[]"  multiple="multiple">
                                    ...
                                    @foreach ($hospitals as $hospital)
                                        <option   @selected(in_array($hospital->id, old('hospital_id', []))) value="{{ $hospital->id }}">
                            ...
                            <div class="col-md-9">
                                ...
                                <select class="form-select js-example-basic-multiple" name="clinic_id[]"  multiple="multiple">
                                    ...
                                    @foreach ($clinics as $clinic)
                                        <option   @selected(in_array($clinic->id, old('clinic_id', []))) value="{{ $clinic->id }}">
                    ...
                    <div class="card hk-dash-type-1 overflow-hidden">
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            ...
                            <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}" id="pane-{{ $localeCode }}" role="tabpanel" aria-labelledby="tab-{{ $localeCode }}">
                                <div class="form-group">
                                    <label for="doctor_name-{{ $localeCode }}">{{ __('Doctor Name') }}
                                        {{ $localeCode }}</label>
                                    <input type="text" value="{{ old($localeCode . '.doctor_name') }}" name="{{ $localeCode }}[doctor_name]" id="doctor_name-{{ $localeCode }}" class="form-control">
                                ...
                                <div class="form-group">
                                    <label for="doctor_address-{{ $localeCode }}">{{ __('Doctor Address') }}
                                        {{ $localeCode }}</label>
                                    <input type="text" value="{{ old($localeCode . '.doctor_address') }}" name="{{ $localeCode }}[doctor_address]" id="doctor_address-{{ $localeCode }}" class="form-control">
