            ...
            <div class="card custom-card">
                ...
                <div class="card-body">
                    <table id="responsivemodal-DataTable" class="table table-bordered text-nowrap" style="width:100%">
                        <a href="{{ route('centers.create') }}" class="btn btn-primary">Create</a>
                        <thead>
                            <tr>
                                <th>#</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    {{ Str::limit( $center->description ,25) }}
                                </td>

                                <td>
                                    <?php
                                            $hosp = App\Models\HospitalCenter::where('center_id',$center->id)->pluck('hospital_id');
                                            $lang = app()->getLocale();
                                ...
                                <td>
                                    <?php
                                    $doc = App\Models\DoctorCenter::where('center_id',$center->id)->pluck('doctor_id');
                                    $lang = app()->getLocale();
                                    $doctors = App\Models\DoctorTranslation::whereIn('doctor_id',$doc)->where('locale',$lang)->get();
                                    ?>
                                ...
                                <td>
                                    <div class="d-flex">
                                        <a href="{{ route('centers.edit', $center->id) }}" class="btn btn-primary me-2"><i class="las la-edit"></i></a>
