                ...
                <div class="card custom-card">
                    ...
                    <div class="card-body">
                        <table id="responsivemodal-DataTable" class="table table-bordered text-nowrap" style="width:100%">
                            <a href="{{ route('pharmacies.create') }}" class="btn btn-primary">Create</a>
                            <thead>
                                <tr>
                                    <th>#</th>
                            ...
                            <tbody>
                                @foreach ($data as $pharmacy)
                                    ...
                                    <td>
                                        ...
                                        <td>
                                            {{ Str::limit($pharmacy->description,25 )}}
                                        </td>

                                        @foreach ($pharmacy->getMedia('logo') as $imgs)
                                            <td>
                                        ...
                                        @foreach ($pharmacy->getMedia('image')  as $imgs)
                                            <td>
                                                <img src="{{ $imgs->getUrl() }}" width="75" height="75"
                                                    alt="">
                                            </td>
