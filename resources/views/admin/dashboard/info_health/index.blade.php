                ...
                <div class="card custom-card">
                    ...
                    <div class="card-body">
                        <table id="responsivemodal-DataTable" class="table table-bordered text-nowrap" style="width:100%">
                            <a href="{{ route('info_healths.create') }}" class="btn btn-primary">Create</a>
                            <thead>
                                <tr>
                                    <th>#</th>
                            ...
                            <tbody>
                                @foreach ($data as $info_health)
                                    ...
                                    <td>
                                        ...
                                        <td>
                                            {{ $info_health->description }}
                                        </td>
                                       
                                        @foreach ($info_health->media as $imgs)
                                            <td>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <a href="{{ route('info_healths.edit', $info_health->id) }}"
                                                    class="btn btn-primary me-2"><i class="las la-edit"></i></a>
                                                <form method="post"
                                                    action="{{ route('info_healths.destroy', $info_health->id) }}">
                                                    @csrf
                                                    @method('delete')
