...
@section('content')
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between page-header-breadcrumb">
        <div>
            <h2 class="main-content-title fs-24 mb-1">{{ __('Update Subspecialty') }}</h2>
    ...
    <div class="row row-sm">
        <div class="col-xl-12">
            <div class="card custom-card">
                ...
                <form class="form-horizontal" method="POST" action="{{ route('subspecialties.update' , $subspecialty->id) }}"
                    ...
                    <div class="card-body">
                                ...
                                <div class="col-md-9">
                                    <select class="form-select" name="specialty_id">
                                        ...
                                        @foreach ($specialties as $specialty)
                                         <option @selected($subspecialty->specialty_id == $specialty->id ) value="{{ $specialty->id }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <select class="form-select" name="status">
                                        ...
                                        <option @if ($subspecialty->status == '1') selected @endif value="1">
                                            {{ __('Active') }}
                                        </option>
                                        <option @if ($subspecialty->status == '0') selected @endif value="0">
                                            {{ __('Unactive') }}
                                        </option>
                                    </select>
                                    @error('status')
                        ...
                        <div class="card hk-dash-type-1 overflow-hidden">
                            ...
                            <div class="tab-content" id="nav-tabContent">
                                @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                                @php
                                $translations = $subspecialty->getTranslationsArray()[$localeCode];
                                @endphp
