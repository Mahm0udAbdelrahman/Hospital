...
@section('content')
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between page-header-breadcrumb">
        <div>
            <h2 class="main-content-title fs-24 mb-1">Create Manager Hospital</h2>
            <ol class="breadcrumb mb-0">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Dashboard</a></li>
                <li class="breadcrumb-item active" aria-current="page">Manager Hospitals</li>
            </ol>
        </div>
    </div>
    ...
    <div class="row row-sm">
        <div class="col-xl-12">
            <div class="card custom-card">
                ...
                <form class="form-horizontal" method="POST" action="{{ route('manager_hospitals.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                            ...
                            <div class="row row-sm">
                                ...
                                <div class="col-md-9">
                                    <select class="form-select" name="position_type">
                                        ...
                                        <option value="board_of_directors">{{ __('Board Of Directors') }}</option>
                                        <option value="executive_management">{{ __('Executive Management') }}</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                                ...
                                @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                                    <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}" id="pane-{{ $localeCode }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ old($localeCode . '.position') }}"
